...
■专为印刷、写植字体的设计师（特别是设计正文标准字体的专家）而设。一直以来都没有任何书籍描述过这种难以捉摸的数据。也许有人对其进行过研究，但没有出版过。本书旨在提供这方面的信息，但可能不够全面，作为作者我为此感到遗憾。对于普通读者来说，这些内容并不容易阅读。
...
#tablex(
  ...
  [],[明治以来活字雕刻师的方法, 仅靠感官进行记忆和肉眼观察。],[],[分组、量化和揭示相互关系（图表和公式）],
  [单个字的字形],[A],[⇆],[C],
  [], [⇅], [], [⇅],
  [字体的特征],[B],[],[D],
)
